...
export default function AdminNavPanel({ isMobileMenuOpen, closeMobileMenu }) {
  ...
  return (
    <>
      ...
      {fullUser && (
        <div className={`p-4 border-b border-slate-700 ${isCollapsed ? 'px-2' : 'px-4'}`}>
          <div className="flex items-center gap-3">
            <div className="h-10 w-10 flex items-center justify-center rounded-full bg-gradient-to-br from-blue-500 to-purple-600 text-white text-sm font-bold shadow-lg flex-shrink-0">
      ...
      {isMobile && (
        <nav
          className={`fixed top-0 left-0 h-full w-80 bg-gradient-to-b from-slate-900 to-slate-800 flex flex-col overflow-y-auto shadow-2xl z-50 transform transition-transform duration-300 ${
