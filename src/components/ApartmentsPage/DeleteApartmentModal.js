...
export default function DeleteApartmentModal({ isOpen, onClose, onConfirm, apartment, loading }) {
      ...
      <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4 shadow-2xl border border-gray-200">
        ...
        <div className="text-center">
          <h3 className="text-lg font-medium text-gray-900 mb-2">
            {t('apartments.deleteConfirm.title') || 'Delete Apartment'}
          </h3>
          <p className="text-sm text-gray-500 mb-4">
            {t('apartments.deleteConfirm.message') || 'Are you sure you want to delete this apartment? This action cannot be undone.'}
          </p>
              ...
              <div className="flex items-center">
                <div className="flex-shrink-0 h-8 w-8 rounded-lg overflow-hidden">
                  {apartment.picture ? (
                    ...
                    <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-amber-500 to-orange-500 flex items-center justify-center text-white text-xs font-semibold">
        ...
        <div className="flex gap-3">
          ...
          >
            {t('apartments.deleteConfirm.cancel') || 'Cancel'}
          </button>
          <button
            onClick={onConfirm}
            disabled={loading}
          ...
          >
            {loading ? (
              <span className="flex items-center justify-center gap-2">
                ...
                {t('apartments.deleteConfirm.deleting') || 'Deleting...'}
              </span>
            ) : (
              t('apartments.deleteConfirm.delete') || 'Delete'
            )}
          </button>
        </div>
      </div>
